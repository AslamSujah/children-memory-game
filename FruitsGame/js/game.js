// ================================
// FRUIT MEMORY GAME - MAIN LOGIC
// ================================
// This is the core game engine for the memory matching game
// Suitable for children aged 5-6 years - FRUIT THEME!
...
// 🍎 FRUIT EMOJI OPTIONS - Delicious and colorful fruits!
const CARD_EMOJIS = [
    '🍎', // Red Apple
    '🍊', // Orange
    '🍋', // Lemon
...
function startGame(level) {
    console.log('🍎 Starting Fruit Memory Game - Level:', level);
...
/**
 * Create the game board with fruit cards
...
function createBoard(level) {
    ...
    // Select random fruit emojis for this game
    ...
    console.log('✅ Fruit board created with', shuffledCards.length, 'cards');
}
...
function createCardElement(emoji, id) {
    ...
    cardBack.textContent = '🍎'; // Use apple as the card back
...
function completeGame() {
    console.log('🎉 Fruit Memory Game Complete!');
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🍎 Fruit Memory Game Loaded');
