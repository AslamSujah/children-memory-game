...
// Card emoji options - BEAUTIFUL FLOWERS! 🌸🌺🌻🌷
const CARD_EMOJIS = [
    '🌸', // Cherry Blossom
    '🌺', // Hibiscus
    '🌻', // Sunflower
    ...
    '🌿', // Herb
    '☘️', // Shamrock
    '🌷', // Tulip (duplicate for variety)
    '🌹'  // Rose (duplicate for variety)
];
...
function startGame(level) {
    console.log('🌸 Starting Flower Memory Game - Level:', level);
...
function createBoard(level) {
    ...
    // Select random flower emojis for this game
    const selectedEmojis = CARD_EMOJIS.slice(0, config.pairs);
    
    // Create pairs (each flower appears twice)
    ...
    console.log('✅ Flower garden created with', shuffledCards.length, 'cards');
}
...
function createCardElement(emoji, id) {
    ...
    cardBack.textContent = '🌱'; // Seedling as the back
...
function handleMatch(cardId1, cardId2) {
    console.log('✅ Flower match found!');
    ...
    showFeedback('Beautiful! 🌸', 'positive');
...
function completeGame() {
    console.log('🎉 Flower Garden Complete!');
...
function createConfetti() {
    ...
    // Flower-themed colors (pink, red, yellow, purple, green)
    const colors = ['#ff69b4', '#ff1493', '#ffd700', '#da70d6', '#98fb98', '#ffb6c1'];
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🌸 Flower Memory Game Loaded');
