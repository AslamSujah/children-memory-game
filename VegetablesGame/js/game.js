...
// THEME: Vegetables & Healthy Foods
...
// Card emoji options - VEGETABLES & HEALTHY FOODS THEME
const CARD_EMOJIS = [
    '🥕', // Carrot
    '🥦', // Broccoli
    '🌽', // Corn
...
function startGame(level) {
    console.log('🥕 Starting vegetable memory game - Level:', level);
...
function createBoard(level) {
    ...
    // Select random vegetables for this game
    const selectedEmojis = CARD_EMOJIS.slice(0, config.pairs);
    
    // Create pairs (each vegetable appears twice)
    ...
    console.log('✅ Board created with', shuffledCards.length, 'vegetable cards');
}
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('🥕 Vegetable Memory Game Loaded');
